...
Some types have subtypes for more specific classification while keeping the type-directory mapping:

### `subtype: improvement` (parent type: `resource`)

Configuration improvement proposals generated by `/improve`. Stored in `resources/`.
