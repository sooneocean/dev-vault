...
### daily
- [[2026-03-28]] — (no summary)
- [[2026-03-29]] — Telegram bot 設定、Compound Engineering Plugin、obsidian-agent v0.7.0 升級
- [[2026-03-30]] — 12-agent parallel session — vault schema升級 + 四學科研究深化 + Plan 003/005 Phase 2 + CSM bug fix
...
- [[dexg16-git-and-github]] — Git 設定、GitHub 帳號（sooneocean）、SSH 金鑰、delta 分頁器
- [[dexg16-machine-specs]] — ASUS ROG Zephyrus G16 — i9-185H, 32GB, RTX 4090 Laptop, 2TB NVMe
- [[dexg16-project-layout]] — 工作目錄配置 — DEX_data 分區、Projects 資料夾、主要 Repo
- [[documentary-film-comprehensive-guide]] — 深度探討紀錄電影與紀錄片的區別，分析5部必看奧斯卡提名作品，指南涵蓋導演視角、敘事手法與流媒體平台推薦。
- [[feminist-film-criticism-complete-guide]] — 深入解析女性主義電影學核心概念，從凝視理論到敘述權力，附 3 部經典案例分析
- [[github-全部-repo-清單]] — sooneocean GitHub 帳號下所有 Repo 的完整盤點（35 個 Repo、22 個公開）
- [[github-發布流程]] — 開源專案的標準發布流程 — 版本命名、Release 建立、CHANGELOG 維護
...
- [[research-scan-2026-03-30]] — 自動掃描發現 0 個新工具/論文
- [[sample-article]] — Introduction to the Compound Engineering Writing Framework (CEWF).
- [[session-stop-wrapper-learning]] — Wrapper script 繞過 CLI 限制，從 Stop hook stdin 擷取 last_assistant_message 寫入 journal
- [[toolchain-reference]] — External repos, tools, plugins and config paths used in this project
